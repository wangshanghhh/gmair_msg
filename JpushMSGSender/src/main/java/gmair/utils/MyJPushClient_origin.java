 ...
 */
@Component
public class MyJPushClient_origin {
    @Value("${jpush.appKey}")
    ...
    private static final Logger logger = LoggerFactory.getLogger(MyJPushClient_origin.class);
...
//        System.out.println(jPushUtil.appKey);
//        System.out.println(jPushUtil.masterSecret);
...
//        String msgContent = "msgContent";
 //       String extras = "{pic_url:https://img-blog.csdnimg.cn/20190127162837994.png,text:推送正文}";
//        jPushUtil.sendToAllAndroid(notificationTitle,msgTitle,msgContent);
